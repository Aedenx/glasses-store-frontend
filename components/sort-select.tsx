    ...
    <label className="flex items-center gap-2">
      ...
      <span className="relative">
        <select
          ...
          className="appearance-none rounded-full border border-white/15 bg-white/5 py-2.5 pl-4 pr-10 text-xs font-semibold text-white outline-none transition focus:border-emerald-400/60"
        >
          {options.map((o) => (
            <option key={o.value} value={o.value} className="bg-[#111213]">
              {o.label}
            </option>
          ))}
        </select>
